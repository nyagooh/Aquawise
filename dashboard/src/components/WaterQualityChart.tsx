...
const PARAMS: ParamDef[] = [
  ...
  { key: 'ph',              label: 'pH Level',         unit: 'pH',   safeMin: 6.5, safeMax: 8.5,  explain: 'Healthy range is 6.5–8.5. Outside this range, water is unsafe.' },
  { key: 'dissolvedOxygen', label: 'Dissolved Oxygen', unit: 'mg/L', safeMin: 6,   safeMax: 14,   explain: 'Below 6 mg/L signals pollution. Aquatic life needs dissolved oxygen.' },
