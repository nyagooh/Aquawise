  ...
  return (
    <header className="flex items-center px-8 py-5 gap-5 flex-shrink-0" style={{ background: theme === 'dark' ? '#0B0A14' : '#F4F2FF' }}>
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        <button
          onClick={toggle}
          className="p-3 rounded-2xl bg-white dark:bg-surface-dark border border-line dark:border-line-dark text-txt-secondary dark:text-txt-dark-secondary hover:text-primary dark:hover:text-primary-dark hover:border-primary/20 dark:hover:border-primary-dark/20 transition-all"
        >
        ...
        <button
          ...
          className="relative p-3 rounded-2xl bg-white dark:bg-surface-dark border border-line dark:border-line-dark text-txt-secondary dark:text-txt-dark-secondary hover:text-primary dark:hover:text-primary-dark hover:border-primary/20 dark:hover:border-primary-dark/20 transition-all"
        >
          <Bell size={18} />
          {alertCount > 0 && (
